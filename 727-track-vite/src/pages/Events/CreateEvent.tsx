...
import CreateEventForm from "../../Components/Events/CreateEvent/CreateEventForm.js";
...
function CreateEvent() {
  ...
  useEffect(() => {
    ...
    socket.on("Application:CreateEvent:ServerRes", (worked: boolean) => {
      if (worked) {
        StoreNotification(
          {
            title: "Événement créé ",
            description: `L'événement ${title.current} créé avec succès`,
            status: "success",
          },
          () => {
            navigate("/events");
        ...
        const data: notificationData = {
          ...
          description: `L'événement n'a pas été créé, veuillez réessayer plus tard...`,
          status: "error",
        };
        generateNotification(api, data);
      }
    });
  }, []);
        ...
        >
          ...
          >
            <p className="text-center">
              ...
              >
                Créez un événement sans projet
              </Button>
            </p>
          </div>
          <div
